...
import { changeBossController, changeRoleController, getUsersController } from '../controllers/user.controller';
...
export default function routes(app: Express) {
	...
	app.patch('/changerole/:id', [validateIdFormat, requiresUser], changeRoleController);
